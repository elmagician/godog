We are excited to announce the release of godog v0.11.0-rc2.

Here follows a summary of Notable Changes, the Non Backward Compatible Changes and Deprecation Notices.
The full change log is available [here](https://github.com/elmagician/godog/blob/master/CHANGELOG.md#v0110-rc1).
...
See [CHANGELOG.md](https://github.com/elmagician/godog/blob/master/CHANGELOG.md#v0110-rc1).
